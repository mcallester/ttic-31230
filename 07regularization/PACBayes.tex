...
reducing generalization loss late in training without improving the training loss.  But this may be specific to certain
simple algorithmic problems like numerical addition.
