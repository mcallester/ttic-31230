...
\bigskip
{\bf Problem 13. The Donsker-Varadhan Bound}
...
{\bf Problem:}
The mutual information between two random variables can be defined in various ways.  Use the definitions of entropy, conditional entropy, and KL divergence to show the equivalence of the following two expressions for the mutual information I(x,y).

H(x) - H(x|y) = E_y\left[KL(P(x|y),P(x))\right]
