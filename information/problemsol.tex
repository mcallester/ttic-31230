...
\bigskip
{\bf Problem 6.}  Consider the distribution on non-negative integers
...
\ignore{$c(i)$ is the string consisting of $i$ ones followed by a zero.
...
\bigskip
{\bf Problem 7.}  Problem 2 was on converting probabilities to
...
\bigskip
{\bf Problem 8.} Shannon's source coding
...
\solution{First, the probability of nontermination in the procedure
  defined by problem 7 must be nonzero.  This is because probability
