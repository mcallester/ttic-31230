...
\begin{eqnarray*}
s[\ell,h,t,t'] & = &\frac{1}{\sqrt{K}} \sum_k\;\left\{\begin{array}{ll}\;\;\left(\sum_j\;W^Q[\ell,h,k,j]M[\ell,t,j]\right) \\
\times \left(\sum_j\;W^K[\ell,h,k,j]M[\ell,t',j]\right) \end{array}\right.\\
\\
{\color{red} \alpha[\ell,h,t,t']} & {\color{red} =} & {\color{red} \softmax_{t'}t \;s[\ell,h,t,t']}\;\;\;\mbox{the attention} \\
\\
V[\ell,h,t,i] & = & \sum_{t',j}\;\alpha[\ell,h,t,t']W^V[\ell,h,i,j]M[\ell,t',j]
\end{eqnarray*}
