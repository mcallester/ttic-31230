...
{\Huge
  ...
  \vfill
  \centerline{\bf Some Information Theory}
...
\vfill
For any probability distribution $P$ on a (discrete) set ${\cal Y}$
there exist a code mapping ${\cal Y}$ to bit strings such that the number of bits used to represent $y$ is no larger than $- \log_2 P(y) + 1$.
