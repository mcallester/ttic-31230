...
\vfill
With $\epsilon' \sim {\cal N}(0,\sqrt{\eta}\sigma)$.
...
\epsilon & \sim & {\cal N}(0,\sqrt{\eta}\sigma)
\end{eqnarray*}
...
{\color{red} $$d\Phi =  -g(\Phi)dt + \epsilon \sqrt{dt}\;\;\;\;\;\; \epsilon \sim {\cal N}(0,\sqrt{\eta}\sigma)$$}
