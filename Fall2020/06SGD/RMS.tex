...
\vfill
Adam can be viewed as an elaboration of RMSProp.
...
\vfill
To compute $\sum_b \;\hat{g}_{t,b}[i]^2$ we would need to maintain a batch index in the gradiant attribute of parameters.
