...
$$z(t) = y + \sigma\epsilon \sqrt{t}\;\;\;\epsilon \sim {\cal N}(0,I)$$

\slide{Brownian Motion}

We can sample directly from $z(t+\Delta t)$ given $z(t)$ using

$$z(t+\Delta t) =  z(t) + \sigma\epsilon\sqrt{\Delta t},\;\;\;\epsilon \sim {\cal N}(0,I)$$

\vfill
For Brownian motion this equation holds for any continuous $t \geq 0$.
and $\Delta t \geq 0$.
