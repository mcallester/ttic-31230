...
\bigskip
{\bf Problem 6. 20 pts}  Consider the distribution on non-negative integers
...
\bigskip
{\bf Problem 7. 30 pts}  Problem 2 was on converting probabilities to
...
\bigskip
{\bf Problem 8. 30 pts} Shannon's source coding
...
\bigskip
{\bf Problem 10: The Donsker-Varadhan Bound}
...
\bigskip
{\bf Problem 11: (25 pts).}  This problem is on softmax, entropy and cross entropy.  Let the variable $i$ range over the non-negative integers (0 to $\infty$).
