...
The entropy of a distribution $\pop$ is defined by

$${\color{red} H(\pop) = E_{y \sim \pop} \;- \ln P(y)}\;\;\mbox{in units of ``nats''}$$

$${\color{red} H_2(\pop) = E_{y \sim \pop} \;- \log_2 P(y)}\; \mbox{in units of bits}$$
...
\vfill
Universality assumption: {\color{red} $P_\Phi$ can represent any distribution.}
...
\slideplain{The rearrangement Trick}
...
\vfill
$$E_{x \sim P} \;\ln \left(\prod_i A_i\right)$$
}
