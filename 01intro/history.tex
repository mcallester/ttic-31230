...
\slide{An Open Problem Slide from the 2023 class}
...
\vfill
{\bf Update:} Recent developments would indicate that great progress on proof-assistants are on the horizon.
...
\item {\color{red} Backtracking Chain of Thought}
\end{itemize}
