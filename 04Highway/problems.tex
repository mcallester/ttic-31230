...
\medskip
{\bf Problem 1.} Consider a computation function $f$ that takes a tensor (such as a layer
...
\medskip
{\bf Problem 3.}  This problem is on initialization.  Consider a single unit defined by
...
\bigskip
{\bf Problem 4.} Consider a bottleneck multi-layer perceptron (MLP) with residual connections
