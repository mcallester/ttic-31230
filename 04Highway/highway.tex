...
We reduce the number of channels to ${\color{red} K < J_\ell}$ before doing the convolution.
...
\\
h_{t+1}[b,J] & = & G_t[b,J] \odot h_t[b,J] + (1-G_t[b,J])\odot R_t[b,J]\;\;\mbox{(confusing version)} \\
\\
