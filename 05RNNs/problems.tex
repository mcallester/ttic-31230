...
\bigskip
~{\bf Problem 2.} A UGRNN cell for computing $h[b,t,J]$ from $h[b,t-1,J]$ and $x[b,t,J]$ can be written as
...
\bigskip
\bigskip
~{\bf Problem 3.} This problem considers ``blank language modeling'' which is used in BERT.
...
~ {\bf Problem 4.} In machine translation with attention the translation is generated from an autoregressive language model for the target langauge translation given the source language sentence.
