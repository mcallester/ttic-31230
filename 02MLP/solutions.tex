...
\bigskip
~{\bf Problem 5. Backpropagation through a UGRNN.}
...
\bigskip
~{\bf Problem 6. Writing framework code.} Consider a function $c:R^d \times R^s \rightarrow R^s$, in other words a function that takes a
