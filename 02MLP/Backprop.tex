...
{\color{red}
$$\begin{array}{lcl}
(4)\; \partial{\cal L}/\partial r & = & \frac{1}{2\sqrt{r}} \bigskip \\
\bigskip
(3)\; \partial{\cal L}/\partial u & = & \frac{\partial{\cal L}}{\partial r}\frac{\partial r}{\partial u} \;=\; \partial {\cal L}/\partial r \\
\bigskip
(2)\; \partial{\cal L}/\partial y & = &  \frac{\partial{\cal L}}{\partial w}\frac{\partial w}{\partial y} \;=\; (\partial {\cal L}/\partial w)*(2y) \\
\bigskip
(1)\; \partial{\cal L}/\partial x & = & \frac{\partial{\cal L}}{\partial u}\frac{\partial u}{\partial x} \;=\; (\partial {\cal L}/\partial u) * (2x)
\end{array}$$
}
}
...
\centerline{For each variable $w$, $w.\grad$ holds $\frac{\partial {\cal L}}{\partial w}$}
