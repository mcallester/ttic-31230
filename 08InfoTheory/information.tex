...
{\Huge
  ...
  \vfill
  \centerline{\bf Differential Entropy}
  \vfill
\vfill
\vfill
...
\vfill
Define $P_{\train,\sigma}$ by
$$(x,y + \sigma\epsilon), \;(x,y) \sim \train, \epsilon \sim {\cal N}(0,I)$$
...
{\huge
\begin{eqnarray*}
\Phi^* & = & \argmin_{\Phi}\; KL(p_\train(z|y),p_\pri(z)) \;{\color{red} +\; \lambda\;\mathrm{Dist}(y,\hat{y}_\dec(z))}
\end{eqnarray*}
}
