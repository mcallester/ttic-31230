...
$$\Phi^* = \argmin_\Phi\;E_{y,z \sim Q_\Phi(z|y)} \; \;-\ln \frac{P_\Phi(z)P_\Phi(y|z)}{Q_\Phi(z|y)}$$
...
$$\Phi^* = \argmin_\Phi\;\begin{array}{ll} & E_{y,z \sim Q_\Phi(z|y)} \; \;-\ln P_\Phi(y|z) \\ \\ + & E_{y,z \sim P_\Phi(z|y)} \; \;-\ln Q_\Phi(y|z) \end{array}$$
