...
These slides on progressive VAES were written``gedanken'' (as a thought experiment) while teaching deep learning
in 2021.

\vfill
The original motivation for progressive VAEs was to provide a theoretically clean approach to a multi-layer VQ-VAEs.

\vfill
However, this formulation of progressive VAEs will be useful in understanding diffusion models (currently very popular).
